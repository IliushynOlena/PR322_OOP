...
{
private:
    string model;//"ukrTrain"
    int countVagons;//4
    List<Vagon> vagons;//head = 0x12345, tail = 0x258963
public:
    Train()
    {
        countVagons = 0;
    }
    Train(const Train&other):vagons(other.vagons)//copy
    {
...
int main() {
    ...
    Train newTrain(ukrzaliz);//copy ctor
    newTrain.PrintTrain();

   // newTrain = ukrzaliz;//operator =
